...
@RestController
@RequestMapping("/api/same-application-kafka")
public class SameApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SameApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SameApplicationKafkaResource(KafkaProperties kafkaProperties) {
