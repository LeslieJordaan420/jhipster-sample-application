...
public class CacheConfiguration {
        ...
        if (this.registration == null) { // if registry is not defined, use native discovery
            ...
            return () ->
                GlobalConfigurationBuilder
                    ...
                    .defaultCacheName("infinispan-sameApplication-cluster-cache")
                    .transport()
                    .defaultTransport()
                    .addProperty("configurationFile", jHipsterProperties.getCache().getInfinispan().getConfigFile())
                    .clusterName("infinispan-sameApplication-cluster")
                    .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    za.co.signio.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    za.co.signio.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(
                    cacheName ->
                        manager.defineConfiguration(
